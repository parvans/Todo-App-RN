...
// async storage is  React Native's simple, promise based api  for persisting
//small bits of data on a user's device. Think of it's as the mobile-app equivalent
